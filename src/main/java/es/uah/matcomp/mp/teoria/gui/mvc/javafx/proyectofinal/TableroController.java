                ...
                if (modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().getNumeroElementos() == 2) {
                    ...
                    if (reproduccion_primero + reproduccion_segundo >= 100) {
                        if ((modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().getElemento(0).getDato() instanceof TipoBasico == true) && (modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().getElemento(1).getDato() instanceof TipoBasico == true)) {
                            modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().add(new TipoBasico(this.getSiguienteID(), modelTablero.original.num_turnos + 1, model.original.vidas, model.original.reproduccion, model.original.clonado, turno));
                            ...
                            modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().add(new TipoNormal(this.getSiguienteID(), modelTablero.original.num_turnos + 1, model.original.vidas, model.original.reproduccion, model.original.clonado, turno));
                            ...
                            modelTablero.original.listaX.getElemento(i).getData().getElemento(j).getData().getListaIndividuos().add(new TipoAvanzado(this.getSiguienteID(), modelTablero.original.num_turnos + 1, model.original.vidas, model.original.reproduccion, model.original.clonado, turno));
