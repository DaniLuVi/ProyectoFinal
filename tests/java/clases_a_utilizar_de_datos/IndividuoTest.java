...
class IndividuoTest {
    ...
    @Test
    void testToString() {
        TipoBasico t1 = new TipoBasico(1, 3, 4, 45, 43, 0, "TipoBasico");
        TipoNormal t2 = new TipoNormal(2, 3, 4, 65, 78, 0, "TipoNormal");
        TipoAvanzado t3 = new TipoAvanzado(3, 4, 5, 32,89, 0, "TipoAvanzado");
