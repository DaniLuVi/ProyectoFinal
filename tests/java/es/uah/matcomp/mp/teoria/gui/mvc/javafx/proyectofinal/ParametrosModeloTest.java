...
class ParametrosModeloTest {
    ...
    @Test
    void getFilas() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 0, 0, 5, 7, 0, 78, 34, 56, 65, 98, 12, 34, 54);
        assertEquals(3, para.getFilas());
    }

    @Test
    void setFilas() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 0, 0, 5, 7, 78, 0, 34, 56, 65, 98, 12, 34, 54);
    ...
    @Test
    void getId() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 9, 0, 5, 7, 78, 0, 34, 56, 65, 98, 12, 34, 54);
        assertEquals(9, para.getId());
    }

    @Test
    void setId() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 9, 0, 5, 7, 78, 0, 34, 56, 65, 98, 12, 34, 54);
        assertDoesNotThrow(()-> para.setId(9));
        assertEquals(9, para.getId(), "Este no es el identificador que esperaba");
    }

    @Test
    void getGeneracion() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 9, 0, 5, 7, 78, 0, 34, 56, 65, 98, 12, 34, 54);
        assertEquals(0, para.getGeneracion());
    }

    @Test
    void setGeneracion() {
        ParametrosModelo para = new ParametrosModelo(3, 4, 9, 0, 5, 7, 78, 0, 34, 56, 65, 98, 12, 34, 54);
        assertDoesNotThrow(()-> para.setGeneracion(0));
        assertEquals(0, para.getGeneracion(), "Esta no es la generación en la que me esperaba encontrar");
    }
